...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "🏷 Title: <a href={url}>{title}</a>\n🎭 Genres: {genres}\n📀 RunTime: {runtime} Minutes\n📆 Release info: <a href={url}/releaseinfo>{release_date}</a>\n🌟 Rating: {rating} / 10\n📜Director: <a href={url}/fullcredits/director>{director}</a>\n\n👥 Cast: <a href={url}/fullcredits/cast>{cast}</a>\n🖋 StoryLine: <code>{plot}</code>")
