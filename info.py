...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>🎬 ᴛɪᴛʟᴇ:</b> <i><a href={url}>{title}</a></i>\n<b>🎭 ɢᴇɴʀᴇs:</b> <i>{genres}</i>\n<b>📆 ʀᴇʟᴇᴀsᴇ ɪɴғᴏ:</b> <i><a href={url}/releaseinfo>{release_date}</a></i>\n<b>🌟 ʀᴀᴛɪɴɢ:</b> <i>{rating} / 10</i>\n<b>📌 ᴄᴀsᴛ:</b> <i>{cast}</i>\n<b>🖋 sᴛᴏʀʏʟɪɴᴇ:</b> <i>{plot}</i>")
