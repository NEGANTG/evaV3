...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "🎬 ᴛɪᴛʟᴇ: <i><a href={url}>{title}</a></i>\n🎭 ɢᴇɴʀᴇs: <i>{genres}</i>\n📆 ʀᴇʟᴇᴀsᴇ ɪɴғᴏ: <i><a href={url}/releaseinfo>{release_date}</a></i>\n🌟 ʀᴀᴛɪɴɢ: <i>{rating} / 10</i>\n👥 ᴄᴀsᴛ: <i><a href={url}/fullcredits/cast>{cast}</a></i>\n🖋 sᴛᴏʀʏʟɪɴᴇ: <i>{plot}</i>")
